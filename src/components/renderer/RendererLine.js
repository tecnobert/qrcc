...
function getParamInfoLine() {
  return [
    ...
    },
    {
      ...
      key: "Espessura de conexão",
      default: 50,
    },
    {
      type: ParamTypes.TEXT_EDITOR,
      key: "Opacidade da conexão",
      default: 100,
    },
    {
      type: ParamTypes.SELECTOR,
...
RendererLine.detail = <div>Lianliankan, direções opcionais</div>;

RendererLine2.detail = <div>Entrelaçados</div>;

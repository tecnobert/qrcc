        ...
        if (posType === 0) {
          ...
          pointList.push(
            <path
              ...
              d={sq25}
              stroke={posColor}
              strokeWidth={(100 / 6) * (1 - (1 - 0.8) * 0.75)}
              fill="none"
              transform={
                "translate(" +
                String(x - 2.5) +
  ...
  return [
    {
      ...
      default: 1,
      choices: ["Retângulo", "Volta"],
    },
    {
      type: ParamTypes.SELECTOR,
      key: "Função de interferência",
      default: 0,
      choices: ["A", "B"],
    },
    {
    ...
    },
    {
      ...
      key: "Cor do ponto de informação 1",
      default: "#000000",
    },
    {
      type: ParamTypes.COLOR_EDITOR,
      key: "Cor do ponto de informação 2",
      default: "#000000",
    },
    {
      type: ParamTypes.COLOR_EDITOR,
...
RendererFuncA.detail = <div>Interferência pontual</div>;

RendererFuncB.detail = <div>Interferência de linha</div>;
